...
const renderGallery = (container, pagination) => {
...
const renderModalInfo = (infoContainer, asset, user) => {
    render(
...
const addInteractivity = (container, callback) => {
...
const animated = document.querySelector('#intro-anim .white-dot');
